...
<h3> `r fontawesome::fa("github", "black")` &nbsp; [github.com/xindyhu/pit-ds-data-viz-workshop](https://github.com/xindyhu/pit-ds-data-viz-workshop.git)

![](img/gw_primary_2c_0.png){.absolute top=600 left=1200 width="300"}
![](img/PIT-UN-logo.webp){.absolute top=680 left=1550 width="400"}
...
**Try it yourself in the lab session this afternoon**
